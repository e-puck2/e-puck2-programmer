...
#define STATUS_COMMAND_RESET_BIT			1 
//Activate the USB interface and write protect the registers 0x00 to 0xFE
#define STATUS_COMMAND_USB_ATTACH_BIT		0  


//////////// FUNCTIONS ///////////////


//Resets the registers of the USB2513B hub
void USB2513B_reset(void);
//Set the configuration of the chip
