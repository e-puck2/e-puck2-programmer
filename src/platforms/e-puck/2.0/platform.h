...
#define DFSDM_DATIN1_PORT 	GPIOA
#define	DFSDM_DATIN1_PIN 	GPIO4

#define DFSDM_DATIN2_PORT 	GPIOB
#define	DFSDM_DATIN2_PIN 	GPIO14

#define DFSDM_CKOUT_PORT 	GPIOA
#define	DFSDM_CKOUT_PIN 	GPIO8
