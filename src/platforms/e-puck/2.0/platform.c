...
/* Can be needed for TRACESWO but not yet. */
	...
	//setup dsfsm pins
	gpio_set_output_options(DFSDM_DATIN1_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_100MHZ, DFSDM_DATIN1_PIN);
	gpio_mode_setup(DFSDM_DATIN1_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, DFSDM_DATIN1_PIN);
	gpio_set_af(DFSDM_DATIN1_PORT, GPIO_AF8, DFSDM_DATIN1_PIN);

	gpio_set_output_options(DFSDM_DATIN2_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_100MHZ, DFSDM_DATIN2_PIN);
	gpio_mode_setup(DFSDM_DATIN2_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, DFSDM_DATIN2_PIN);
	gpio_set_af(DFSDM_DATIN2_PORT, GPIO_AF8, DFSDM_DATIN2_PIN);

	gpio_set_output_options(DFSDM_CKOUT_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_100MHZ, DFSDM_CKOUT_PIN );
	gpio_mode_setup(DFSDM_CKOUT_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, DFSDM_CKOUT_PIN );
	gpio_set_af(DFSDM_CKOUT_PORT, GPIO_AF6, DFSDM_CKOUT_PIN );
