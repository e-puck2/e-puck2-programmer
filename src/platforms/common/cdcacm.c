...
#endif
	AUDIO_CONTROL_IFACE_NUM,
	AUDIO_STREAM_IFACE_NUM,
...
static const struct {
	...
	.header_body = {
		.baInterfaceNr = AUDIO_STREAM_IFACE_NUM, //Audio steaming interface belongs to this Audio control interface
	},
...
#endif
	usbd_ep_setup(dev, 0x85, USB_ENDPOINT_ATTR_ISOCHRONOUS, 16, NULL);
